...
const R = [
  ...
  { name: "안성", slug: "anseong", areas: "안성 시내와 공도 생활권", audience: "지역 매장, 시공, 교육, 기업 서비스", market: "도심과 산업·주거 생활권을 함께 고려한 지역 검색 구성이 필요합니다.", plan: "서비스 범위와 실제 사례를 중심으로 검색 콘텐츠를 구성합니다." },
  { name: "평택", slug: "pyeongtaek", areas: "평택·송탄·고덕 생활권", audience: "병원, 교육, 외식, 기업 서비스", market: "빠르게 변하는 생활권별 고객 수요를 구분해 전달해야 합니다.", plan: "생활권별 페이지와 업종 콘텐츠를 연결해 상담 경로를 단순화합니다." },
  { name: "부산", slug: "busan", areas: "부산 주요 구·군", audience: "관광, 외식, 의료, 전문 서비스", market: "넓은 권역과 다양한 상권을 세부 지역과 업종으로 나눠 접근해야 합니다.", plan: "핵심 상권과 업종부터 콘텐츠를 구축하고 범위를 단계적으로 넓힙니다." },
  { name: "이천", slug: "icheon", areas: "이천 시내와 주요 읍·면", audience: "지역 매장, 시공, 교육, 기업 서비스", market: "방문 고객과 출장 서비스 고객이 확인할 정보를 구분하는 것이 중요합니다.", plan: "지역 범위와 상담 절차, 사례를 명확히 보여주는 검색 페이지를 운영합니다." },
  { name: "증평", slug: "jeungpyeong", areas: "증평읍과 도안면", audience: "지역 매장, 교육, 시공, 생활 서비스", market: "가까운 생활권에서 실제 이용 가능한 브랜드라는 신뢰를 먼저 만들어야 합니다.", plan: "서비스 가능 범위와 실제 작업 내용을 중심으로 지역 검색 기반을 만듭니다." },
];
